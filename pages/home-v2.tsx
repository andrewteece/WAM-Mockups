            ...
            <div className='max-w-7xl mx-auto px-6 py-4'>
              <div className='flex items-center justify-between'>
                ...
                <div className='hidden md:flex items-center space-x-8'>
                  <a
                    href='#products'
                    className='text-gray-700 dark:text-gray-300 hover:text-bapi-blue dark:hover:text-bapi-yellow transition-colors font-medium'
                  >
                    Products
                  </a>
                  <a
                ...
                <div className='flex items-center space-x-4'>
                  ...
                  >
                    {isDark ? (
                      <svg
                        className='w-5 h-5 text-bapi-yellow'
                        fill='currentColor'
                        viewBox='0 0 20 20'
                      >
              ...
              <div className='grid md:grid-cols-2 gap-12 items-center'>
                ...
                <div className='space-y-6'>
                  ...
                  <p className='text-xl text-gray-600 dark:text-gray-400 leading-relaxed'>
                    Industry-leading HVAC sensors and building automation
                    controls trusted by engineers worldwide. Delivering
                    accurate, reliable performance for over 30 years.
                  </p>
                  ...
                  <div className='grid grid-cols-3 gap-6 pt-8'>
                    <div>
                      <div className='text-4xl font-black text-bapi-blue dark:text-bapi-yellow'>
                        30+
                      </div>
            ...
            <div className='max-w-7xl mx-auto'>
              <div className='text-center mb-16'>
                ...
                <p className='text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto'>
                  Comprehensive building automation solutions for every
                  application
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: 'Precision temperature monitoring for optimal climate control',
                  },
                  {
                    icon: '💨',
                    title: 'Air Quality Sensors',
                    desc: 'Monitor CO2, VOC, and particulate matter for healthier environments',
                  },
                  {
                    icon: '💧',
                    title: 'Humidity Sensors',
                    desc: 'Accurate humidity measurement for comfort and protection',
                  },
                  {
                    icon: '⚡',
                    title: 'Pressure Sensors',
                    desc: 'Reliable pressure monitoring for HVAC systems',
                  },
                  {
                    icon: '📡',
                    title: 'Wireless Sensors',
                    desc: 'Easy installation with reliable wireless protocols',
                  },
                  {
                    icon: '🎛️',
                    title: 'Controls & Accessories',
                    desc: 'Complete your building automation system',
                  },
                ].map((product, index) => (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <a
                      href='#'
                      className='inline-flex items-center text-bapi-blue dark:text-bapi-yellow font-bold hover:gap-2 transition-all'
                    >
                      Learn More
                      <svg
                    ...
                    {[
                      {
                        ...
                        desc: 'Precision calibration and quality testing ensure reliable measurements',
                      },
                      {
                        title: 'Made in USA',
                        desc: 'Designed, engineered, and manufactured in our Minnesota facility',
                      },
                      {
                        title: '5-Year Warranty',
                        desc: 'Backed by comprehensive warranty and exceptional support',
                      },
                      {
                        title: 'Protocol Flexibility',
                        desc: 'Support for BACnet, Modbus, and other major protocols',
                      },
                    ].map((feature, index) => (
                ...
                <div>
                  ...
                  <ul className='space-y-2'>
                    <li>
                      <a
                        href='#'
                        className='hover:text-bapi-yellow transition-colors'
                      >
                        Temperature
                      </a>
                    </li>
