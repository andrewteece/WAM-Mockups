        ...
        <section className="container section specs">
          <div className="specGrid">
            <div className="specCard reveal">
              <h4>Outputs</h4>
              <p className="muted">0–10V, 4–20mA, Modbus — field-selectable options for retrofit projects.</p>
            </div>
            <div className="specCard reveal">
              <h4>Accuracy</h4>
              <p className="muted">±0.3°C; humidity options down to ±2% RH for stable control.</p>
            </div>
            <div className="specCard reveal">
              <h4>Mounting</h4>
              <p className="muted">Wall, duct, immersion and outdoor options available with accessory probes.</p>
            </div>
          </div>
        </section>
